...
check("six hikes, median %", gold_usd["6M"]["med"], 3.95); check("six hikes, higher of 6", gold_usd["6M"]["up"], 3, 0)
check("five hikes (1997 dropped), median %", gold_five["6M"]["med"], 8.43); check("usual six-month median %", gold_usd["6M"]["base"], 3.45)
