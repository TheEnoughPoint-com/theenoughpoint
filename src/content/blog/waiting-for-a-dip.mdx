...
Waiting for a dip is not a strategy until it has a deadline. Without one, "I will buy the next correction" is not a rule — it is a mood, and moods are why people hold cash for years and then buy at the top anyway. A Fed rate hike is the kind of headline that turns the mood into a plan; [what actually followed the six previous first hikes](/fed-rate-hike-us-shares-gold-sti/) is its own piece.
