...
cover: "/img/Published/sg-couple-saving-coins.jpg"
date: "2026-07-15"
...
**Liquidity.** SRS funds can be withdrawn before the statutory retirement age, subject to a penalty and full taxation on the withdrawn amount. CPF top-ups made via RSTU are effectively locked into the CPF system — not withdrawable as a lump sum in the way SRS funds technically can be, penalty or not. The same lock applies, for decades longer, when the top-up goes into a child's account: see [Should I top up my child's CPF or invest for them?](/child-cpf-top-up-early/)

**What happens to unused relief.** SRS contributions can be invested inside the SRS account across a fairly wide range of instruments. From 13 October 2026 that range will include Ireland-domiciled index funds on SGX, which matters for anyone whose SRS money holds US-domiciled funds: [what changes on 13 October](/sgx-irish-etfs-us-estate-tax/). CPF top-ups earn the CPF interest rates on the relevant account, which for many people is difficult to beat on a risk-adjusted basis, but comes with far less flexibility in how the money is used.
