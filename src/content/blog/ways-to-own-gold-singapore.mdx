...
takeaways:
  - "There are <strong>five</strong> ways to own gold in Singapore — physical bullion, a bank gold account, two SGX ETFs, overseas funds, miners — and they are different assets, not five wrappers on one thing."
  - "Singapore deliberately made itself a bullion hub: investment-grade gold of 99.5% purity or higher has been <strong>GST-free since October 2012</strong>."
  - "The record cuts both ways: central banks bought roughly <strong>1,000 tonnes a year</strong> in 2022–2024, double their prior pace — and 1980 to 1999 cost holders about 70%."
  - "Miners are businesses that multiply gold's moves both ways: <strong>+154.8%</strong> in 2025 against gold's +63.7%, and −77% across 2011–2016 against gold's −43%."
  - "The wrapper decides the law: one SGX gold fund carries an <strong>unsettled US death-tax question</strong>; the other, a Singapore trust, never raises it."
authorId: "fi"
excerpt: |
...
That is the case for owning some, and it is narrower than the sales pitch. Gold did not rescue anyone when shares fell. It simply tended **not to fall with them** — and 2022 is the year worth a second look, because bonds, the usual shock absorber, dropped 13% alongside shares while gold finished roughly flat.

**The bill for that insurance arrives in the good years.** Gold fell 28.3% in 2013 and 10.7% in 2015 while shares climbed. The twenty-year slide after 1980 is the same charge paid over a generation. Even this year has the short-term version: gold sits about **24% below its late-January peak**. It also fell into September's Fed rate hike, as it did into four of the six first hikes before it; [what followed those six](/fed-rate-hike-us-shares-gold-sti/) is its own piece.
...
None of that is a forecast. If you want one, take it from named publishers and read the incentive label first. The [LBMA's annual survey](https://www.lbma.org.uk/prices-and-data/lbma-annual-precious-metals-forecast-survey) collects about thirty named analysts each January — bulls and bears in one table. The [World Gold Council](https://www.gold.org/goldhub/research/gold-outlook-2026) publishes scenario outlooks — rigorous, and from the industry body whose job is gold demand, which it says plainly. [J.P. Morgan's public long-term assumptions](https://am.jpmorgan.com/us/en/asset-management/adv/about-us/media/press-releases/jp-morgan-releases-2026-long-term-capital-market-assumptions/) carry a gold figure for the next decade rather than the next quarter. This piece imports none of their numbers.
...
**What you own.** The metal itself — no fund, no counterparty, no annual expense ratio. Singapore made this deliberately easy: investment-grade gold of at least 99.5% purity, in tradable form, has been **[exempt from GST since 1 October 2012](https://www.iras.gov.sg/media/docs/default-source/e-tax/gst-guide-on-exemption-of-investment-precious-metals7f0062ff-780a-4a53-90fa-e1f3b1e25770.pdf?sfvrsn=475e50d2_41)** (IRAS), a rule written to turn the country into a bullion hub.
...
**What it costs.** The standing example is UOB's Gold Savings Account: **0.25% a year** of the highest balance recorded each month, plus GST on the charge, simplified from 1 April 2026 ([the bank's rates page](https://www.uob.com.sg/personal/invest/gold-and-silver.page)).
...
**What you own.** Units in a trust holding allocated bars — same metal, different law. The fund listed here since 2006 is a **[US grantor trust](https://www.ssga.com/library-content/pdfs/etf/us/SPDR_GOLD_TRUST_PROSPECTUS.pdf)**. The one listed in March 2026 is a **[Singapore unit trust](https://www.lionglobalinvestors.com/en/fund-lionglobal-singapore-physical-gold-etf.html)** with its bars vaulted and insured in Singapore.

**What it costs.** 0.40% a year for the US wrapper — the record-setter above, and the only gold instrument CPF money can buy, within [CPF-IS's 10% gold limit](https://www.cpf.gov.sg/member/growing-your-savings/earning-higher-returns/investing-your-cpf-savings). 0.39% for the Singapore wrapper, which is SRS-eligible.

**The catch.** The difference surfaces on the holder's death. Singapore abolished estate duty in 2008, so the only death-tax question is a foreign one — and whether US estate tax reaches a grantor-trust unit is genuinely unsettled. The Singapore wrapper never raises the question. The US$60,000 / 40% mechanics are [in the estate piece](/us-estate-tax-singapore-investors). One difference, not a verdict: the US fund is far larger, trades far more here, and is the CPF-eligible one.
...
**The catch.** For US listings, the estate question above applies at full strength. For equity funds, an Irish wrapper removes US estate exposure cleanly, and from 13 October 2026 [some are due to trade on SGX itself](/sgx-irish-etfs-us-estate-tax/); **for gold there is no equally clean answer**, because where an ETC legally sits does not follow from its UCITS label. If the death-law question matters to you, gold is the asset class where it is hardest to engineer away.
...
**What it costs.** 0.51% a year for the standard US-listed miner fund ([VanEck's GDX](https://www.vaneck.com/us/en/investments/gold-miners-etf-gdx/)); 0.53% for [its Irish-domiciled twin listed in London](https://www.vaneck.com/uk/en/investments/gold-miners-etf/) (ISIN IE00BQQP9F84).
...
1. **Start with the job, not the route.** Insurance held outside the financial system means physical metal. Price exposure using CPF money has exactly one route. A leveraged bet on the gold price means miners — an equity bet, sized like one.
...
- **Bank gold-account charge** (0.25% a year from 1 Apr 2026, GST on the charge; previously the *higher* of 0.12g a month or 0.25%, which quietly made small balances dearer; S$100 per 100g physical conversion): [UOB's published rates page](https://www.uob.com.sg/personal/invest/gold-and-silver.page), checked 6 August 2026.
...
- **Estate mechanics and the unsettled grantor-trust situs question**: as sourced in [our estate piece](/us-estate-tax-singapore-investors) (IRS 706-NA and 706 instructions; as far as we could establish from primary sources, the uncertainty is genuine — documented there and not resolved here).
...
- **Where published gold views live**, with incentives labelled: [LBMA annual forecast survey](https://www.lbma.org.uk/prices-and-data/lbma-annual-precious-metals-forecast-survey); [World Gold Council outlooks](https://www.gold.org/goldhub/research/gold-outlook-2026) and [Qaurum, its valuation tool](https://www.gold.org/goldhub/portfolio-tools/gold-valuation-framework); [J.P. Morgan's public Long-Term Capital Market Assumptions](https://am.jpmorgan.com/us/en/asset-management/adv/about-us/media/press-releases/jp-morgan-releases-2026-long-term-capital-market-assumptions/) — none of their numbers are used here.
